...
/* 
 * $Id: //depot/argus/argus-3.0/clients/include/argus_main.h#17 $
...
int ArgusAddHostList (struct ArgusParserStruct *, char *, int);
...
int ArgusWriteNewLogfile (struct ArgusParserStruct *parser, struct ArgusWfileStruct *, struct ArgusRecord *);

int parseUserDataArg (char **, char **, int);
int ArgusCheckTimeFormat (struct tm *tm, char *str);
int ArgusParseTime (struct ArgusParserStruct *parser, struct tm *, struct tm *, char *, char);
...
extern int ArgusAddHostList (struct ArgusParserStruct *, char *, int);
...
extern int ArgusParseTime (struct ArgusParserStruct *parser, struct tm *, struct tm *, char *, char);
