...
/* 
 * $Id: //depot/argus/clients/clients/racount.c#22 $
 * $DateTime: 2009/05/20 12:52:03 $
 * $Change: 1739 $
 */
...
signed long long ArgusIPProtoRecs[0x10000];
signed long long ArgusEtherProtoRecs[0x10000];
         ...
         case ARGUS_FLOW_CLASSIC5TUPLE: {
            switch (flow->hdr.argus_dsrvl8.qual) {
               ...
               case ARGUS_TYPE_IPV4:
                  ArgusIPProtoRecs[flow->ip_flow.ip_p]++;
                  break;
            }
         }
      }
